...
par(mfrow=c(1,2))
plotDCA(prev=0.4, sens=0.9, spec=0.5, rsens=0.7, rspec=0.995, psens=0.9, pspec=0.995, ymax=0.5, plotlegend = F, title="Hospitalized patients")
plotDCA(prev=0.1, sens=0.5, spec=0.8, rsens=0.7, rspec=0.995, psens=0.9, pspec=0.995, ymax=0.5, title="Mildly symptomatic patients")
...
si_sd <- 4
rt <- 1
f <- 0.5 #contact notification efficacy
sxonsetday <- 2
duration <- 10
...
contacttransmits <- contactonset <- casetransmits + serial + sample(casetransmits, npts, T)
